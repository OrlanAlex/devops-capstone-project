...
![Build Status](https://github.com/OrlanAlex/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
Do Not fork this code! It is meant to be used by pressing the  <span style=color:white;background:green>**Use this Template**</span> button in GitHub. This will copy the code to your own repository with no connection back to the original repository like a fork would. This is what you want. 1111
